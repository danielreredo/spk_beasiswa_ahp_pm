...
class ReportsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('reports.index', compact('per'));
        //
    }
    ...
    public function show($a, Request $req)
    {
        ...
        // return $a;
        $pro = Pro::all();
        $per=Per::find(session('per'));
        foreach($pro as $p){
            $p->mahs=Mah::where([['pro','=',$p->id_pro], ['per', '=', $a]])->get();
            foreach($p->mahs as $maha){
        ...
        // return $skri;
        return view('reports.show', compact('pro','per'));
        //
    }
