...
@section('hasil')
<a href="{{ url('/hasils') }}" class="nav-link active">
@endsection

@section('title')
<h1 class="m-0 text-dark">Hasil Seleksi Beasiswa PPA Periode {{$per->per}}</h1>
@endsection
        ...
        <div class="col-7">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">List Hasil Seleksi Pendaftar Beasiswa PPA Prodi {{$pr->nm_pro}}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
